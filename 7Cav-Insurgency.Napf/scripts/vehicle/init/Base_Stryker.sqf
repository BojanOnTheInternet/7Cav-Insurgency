[_this select 0,
	...
	(_this select 0) removeMagazines "RHS_96Rnd_40mm_MK19_M1001"; //Removes canister ammo from Mk19 variants (has high performance cost)
	...
	[_this select 0, 6] call ace_cargo_fnc_setSpace; //Sets cargo space to 6wd
